...
let tpl_step3_d = null;
let tpl_step3_e = null;
...
async function loadTemplates(){
  [tpl_start,
    ...
    tpl_step2,
    tpl_step3_base, tpl_step3, tpl_step3_a, tpl_step3_b, tpl_step3_c, tpl_step3_d, tpl_step3_e,
    ...
    new Tpl("step2"),
    new Tpl("step3_base"), new Tpl("step3"), new Tpl("step3_a"), new Tpl("step3_b"), new Tpl("step3_c"),new Tpl("step3_d"),new Tpl("step3_e"),

export class UserUtils {
    ...
    static calculGainsOfTaxesB(user){
      return Math.ceil(
        user.getTaxeB()/100*((user.getMarchands() * 1.8 + UserUtils.calculGainsOfFoires(user) * 0.33 + UserUtils.calculGainsOfMoulins(user) * 17
            + UserUtils.calculGainsOfFonderies(user) * 50 + UserUtils.calculGainsOfChantiers(user) * 70) * 5 + user.getPeople())
      );
    }

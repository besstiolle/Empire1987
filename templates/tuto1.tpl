<c>Bienvenue dans l' E M P I R E !</c>

   Imaginez que vous êtes le gentil seigneur (ou la gente dame) d'un petit fief sans importance de l'Europe du Moyen-Age. Votre pays réunit de nombreux agréments : pas d'industrie, commerce réduit, armée insignifiante, sur ou sous population, vosins haineux, complots, famines, perste, et toutes les autres douceurs quotidiennes du pouvoir.  C'est uniquement la nécessité de survivre pour vous conserver à l'amour de vos bons et loyaux sujets, et non une démoniaque ambition, qui vous pouse à rassembler années après année terres, argent et armées.

   Mais la brièveté de la vie ne vous laisera que peu de temps pour transformer votre baronnie en empire.

   Car la Providence est prête à récompenser votre sage politique par une ascension bien méritée :
